...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5ffb5aec261812001691a05b
...
To start editing your site, you can use the Sanity interface at https://festive-neptune-b5aec.sanity.studio/.
...
Generated at `2021-01-10T19:56:30.118Z` by Stackbit version `0.3.42`.